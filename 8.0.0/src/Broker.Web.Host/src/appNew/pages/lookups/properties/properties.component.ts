...
import { DialogManagePropertyComponent } from './dialog-manage-property.component';
...
export class AdminPropertiesComponent extends DataTableComponentBase {
    ...
    openModal() {
        ...
        this.dialogService.open(DialogManagePropertyComponent, {
            context: {
