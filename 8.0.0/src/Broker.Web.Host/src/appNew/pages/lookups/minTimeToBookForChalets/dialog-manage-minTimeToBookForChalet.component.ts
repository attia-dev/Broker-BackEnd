...
@Component({
    selector: 'ngx-dialog-manage-minTimeToBookForChalet',
    templateUrl: 'dialog-manage-minTimeToBookForChalet.component.html',
    styleUrls: ['minTimeToBookForChalets.component.scss'],
})
export class DialogManageMinTimeToBookForChaletComponent extends AppComponentBase implements OnInit {
    ...
    constructor(injector: Injector, private http: HttpClient, private fb: FormBuilder, private _definitionService: DefinitionServiceProxy, protected ref: NbDialogRef<DialogManageMinTimeToBookForChaletComponent>) {
        super(injector);
