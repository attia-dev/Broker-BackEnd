...
namespace Broker.Customers.Dto
{
    ...
    public class SeekerDto : FullAuditedEntityDto<long>
    {
    ...
    public class GetSeekerInput : DataTableInputDto
    {
        public string Name { get; set; }
    }
    public class PagedSeekerResultRequestDto : PagedResultRequestDto
    {
        public string Name { get; set; }
    }
    public class GetSeekerOutput
    {
