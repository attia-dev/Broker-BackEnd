...
namespace Broker.Customers.Dto
{
    ...
    public class BrokerPersonDto : FullAuditedEntityDto<long>
    {
    ...
    public class GetBrokerPersonInput : DataTableInputDto
    {
        public string Name { get; set; }
    }
    public class PagedBrokerPersonResultRequestDto : PagedResultRequestDto
    {
        public string Name { get; set; }
    }

    public class GetBrokerPersonOutput
    {
        public List<BrokerPersonDto> BrokerPersons { get; set; }
